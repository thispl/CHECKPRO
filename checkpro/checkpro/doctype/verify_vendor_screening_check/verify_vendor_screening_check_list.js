frappe.listview_settings['Verify Vendor Screening Check'] = {
        ...
        listview.page.add_action_item(__("Allocate Check"), function () {
            let d = new frappe.ui.Dialog({
                ...
                primary_action(values) {
                    var method = "checkpro.checkpro.doctype.verify_vendor_screening_check.verify_vendor_screening_check.edu_check"
