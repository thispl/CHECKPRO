frappe.listview_settings['Verify Criminal Record Check'] = {
        ...
        listview.page.add_action_item(__("Allocate Check"), function () {
            let d = new frappe.ui.Dialog({
                ...
                primary_action(values) {
                    var method = "checkpro.checkpro.doctype.verify_criminal_record_check.verify_criminal_record_check.edu_check"
