frappe.listview_settings['Verify Family History Check'] = {
        ...
        listview.page.add_action_item(__("Allocate Check"), function () {
            let d = new frappe.ui.Dialog({
                ...
                primary_action(values) {
                    var method = "checkpro.checkpro.doctype.verify_family_history_check.verify_family_history_check.edu_check"
