frappe.listview_settings['Verify Employment Check'] = {
        ...
        listview.page.add_action_item(__("Allocate Check"), function () {
            let d = new frappe.ui.Dialog({
                ...
                primary_action(values) {
                    var method = "checkpro.checkpro.doctype.verify_employment_check.verify_employment_check.edu_check"
                    var doctype = listview.doctype

                    // console.log(listview.doctype)
